	...
	?>
		<form class="form" action="" method="GET" data-degree-picker>
			<div class="row">
				...
				<button type="submit" class="col-12 col-md-1 btn btn-primary btn-inline h-100" name="submit" disabled><span class="sr-only">View Program</span><span class="fa fa-arrow-right" aria-visible="false"></span></button>
			</div>
		</form>
	<?php
		return ob_get_clean();
