		...
		<form class="form" action="" method="GET" data-degree-picker>
			<div class="container">
				<div class="row">
					...
					<select class="custom-select col-12 col-md mb-2 mr-md-1" id="sel_program_type" name="sel_program_type">
						<option value="" selected>Degree Level</option>
					</select>
					<label class="sr-only" for="sel_interest">Select an Area of Interest</label>
					<select class="custom-select col-12 col-md mb-2 mr-md-1" id="sel_interest" name="sel_interest" disabled>
						<option value="" selected>Interest</option>
					</select>
					<label class="sr-only" for="sel_program">Select Program</label>
					<select class="custom-select col-12 col-md mb-2 mr-md-1" id="sel_program" name="sel_program" disabled>
