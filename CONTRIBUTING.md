# Contributing to Online Child Theme
...
The [issue tracker](https://github.com/UCF/Online-Child-Theme/issues) in Github is the preferred channel for [bug reports](#bug-reports), [feature requests](#feature-requests) and [submitting pull requests](#pull-requests).
...
2. **Check if the issue has been fixed** &mdash; if you're not running the latest version of the theme, please check your code against the repo's `master` branch first (`master` will always contain the latest, stable project code). If you are running the latest version, make sure the problem isn't already resolved in an upcoming [milestone](https://github.com/UCF/Online-Child-Theme/milestones).

### Submit a bug report
If you've followed the steps above and have a valid bug report to submit, you can submit it by [creating a new issue in Github](https://github.com/UCF/Online-Child-Theme/issues/new?template=bug_report.md).
...
If you have a live example of the bug available somewhere public, please include a link in the bug report.  If you're not comfortable including the URL in the Github issue (e.g. it points to a development environment), you can make a note of it in the report (e.g. "see Slack for example URL"), then share the URL in the [#prj-Online-Child-Theme Slack channel](https://ucf-wp.slack.com/messages/prj-Online-Child-Theme/).


## Feature requests

We welcome new feature requests from developers across campus.  Before submitting a new request, think carefully about if the proposed feature aligns with the [goals of the project](https://github.com/UCF/Online-Child-Theme/wiki/#project-goals) and with [UCF's brand](https://www.ucf.edu/brand/). We strongly encourage the discussion of new feature ideas in the [ucf-wp Slack workspace](https://ucf-wp.slack.com/).
...
You can submit a new feature request by [creating a new issue in Github](https://github.com/UCF/Online-Child-Theme/issues/new?template=feature_request.md) and filling out the provided template.
...
2. Clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/Online-Child-Theme.git

   # Navigate to the newly cloned directory
   cd Online-Child-Theme

   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/UCF/Online-Child-Theme.git
   ```
...
5. Commit your changes in logical chunks. Please provide [helpful, readable commit messages](https://chris.beams.io/posts/git-commit/) (avoid nondescriptive messages such as "bugfix" or "minor change").
    ...
    If you're making changes to scss or js files, make sure you're minifying **and committing** those minified file changes.  scss and js file processing should be performed using gulp commands provided in the repo (see [gulpfile.js](https://github.com/UCF/Online-Child-Theme/blob/master/gulpfile.js))
...
### General questions
If you have a general question about the theme, design decisions, or any other question that isn't a help request, please post it in the [#prj-Online-Child-Theme Slack channel](https://ucf-wp.slack.com/messages/prj-Online-Child-Theme/).

### Help
If you need help with using this theme on your site, check out our [project documentation](https://github.com/UCF/Online-Child-Theme/wiki).  If you can't find the answer to your question there, please drop us a line in the [#help-themes Slack channel](https://ucf-wp.slack.com/messages/help-themes/).  You don't need to @mention anyone specific, but **please note that you're using the Online Child Theme when posting your question** and include a link to your site if it's relevant to your question.
