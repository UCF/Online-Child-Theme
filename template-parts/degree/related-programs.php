		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<?php echo do_shortcode( sprintf( '[ucf-post-list post_type="degree" posts_per_page="3" posts_per_row="3" layout="%s" tag="%s" post__not_in="%s"]', $degree_related_programs_layout, $degree_related_programs_tag, $post->ID ) ); ?>
				</div>
			</div>
		</div>
	</section>
