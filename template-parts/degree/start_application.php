...
?>
	<section id="start-your-application" aria-label="Start Your Application">
		<div class="media-background-container bg-inverse py-lg-5 py-4">
			<img class="media-background object-fit-cover hidden-md-down" src="<?php echo ONLINE_THEME_STATIC_URL . '/img/start-your-application-dark-bg.jpg'; ?>" alt="" aria-hidden="true">
